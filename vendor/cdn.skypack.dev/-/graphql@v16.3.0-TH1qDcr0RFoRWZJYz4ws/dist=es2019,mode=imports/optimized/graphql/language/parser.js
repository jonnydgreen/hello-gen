...
class Parser {
  ...
  parseDefinition() {
    ...
    if (keywordToken.kind === TokenKind.NAME) {
      ...
      if (hasDescription) {
        throw syntaxError2(this._lexer.source, this._lexer.token.start, "Unexpected description, descriptions are supported only on type definitions.");
      }
      switch (keywordToken.value) {
        case "query":
        case "mutation":
...
export {Parser, parse, parseConstValue, parseType, parseValue};
export default null;
